...
run_name="ours_seed1"
# run_name="ours_seed2"
results_path="./save/dock/${run_name}/infer_pose"  # replace to your results path
weight_path="./save/dock/${run_name}/checkpoint_last.pt"
...
CUDA_VISIBLE_DEVICES=0 python ./unimol/infer.py --user-dir ./unimol $data_path --valid-subset unseen \
...
export WANDB_RUN_ID="unseen_post10sigma_${run_name}_eval${time}"
...
reference_file="${data_path}unseen.lmdb"  # Your reference file dir
output_path="${results_path}/unseen_protein_ligand_binding_pose_prediction"  # Docking results path
