...
reactive_site_run_name="ours_seed0"
# reactive_site_run_name="ours_seed1"
# reactive_site_run_name="ours_seed2"
results_path="./covDocker_models/reactive_site/${reactive_site_run_name}/infer"  # replace to your results path
...
# infer on test set
docking_run_name="ours_seed0"
# docking_run_name="ours_seed1"
...
weight_path="./covDocker_models/dock/${docking_run_name}/checkpoint_last.pt"
results_path="./covDocker_models/dock/${docking_run_name}/pipe_infer"  # replace to your results path
...
CUDA_VISIBLE_DEVICES=0 python ./unimol/infer.py --user-dir ./unimol $data_path --valid-subset test \
       ...
       --seed $seed --max-pocket-atoms 508 --pocket_max_seq_len 512 
