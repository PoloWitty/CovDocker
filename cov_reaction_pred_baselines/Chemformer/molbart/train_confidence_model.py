...
def main(args):
    ...
    confidence_model.save_logged_data()
    print("Done writing.")
    return
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dropout", type=float, default=util.DEFAULT_DROPOUT)
    parser.add_argument("--contrastive_loss_margin", type=float, default=DEFAULT_MARIN)
